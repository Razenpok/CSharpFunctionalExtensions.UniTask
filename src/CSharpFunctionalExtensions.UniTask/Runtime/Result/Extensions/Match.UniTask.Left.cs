...
namespace CSharpFunctionalExtensions
{
    ...
    {
        /// <summary>
        ///     Returns the result of the given <paramref name="onSuccess"/> valueUniTask action if the calling Result is a success. Otherwise, it returns the result of the given <paramref name="onFailure"/> valueUniTask action.
        /// </summary>
