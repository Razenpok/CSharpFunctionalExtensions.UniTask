...
namespace CSharpFunctionalExtensions
{
    public static partial class AsyncResultExtensionsLeftOperand
    {
        ...
        ///     Executes the given action if the calling result is a success and condition is true. Returns the calling result.
        /// </summary>
        public static UniTask<UnitResult<E>> TapIf<E>(this UniTask<UnitResult<E>> resultUniTask, bool condition, Action action)
        {
            if (condition)
                return resultUniTask.Tap(action);
            else
        ...
        ///     Executes the given action if the calling result is a success and condition is true. Returns the calling result.
        /// </summary>
        public static async UniTask<UnitResult<E>> TapIf<E>(this UniTask<UnitResult<E>> resultUniTask, Func<bool> predicate, Action action)
        {
